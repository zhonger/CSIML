...
def PlotHyperparametr(op_summarys: np.array, filename: str, is_std: bool=True, is_show: bool=False, metric: str="mae"):
    ...
    match metric:
        case "mae":
            ...
            fig.add_trace(go.Scatter(name="Training", y=train_mae, x=x, error_y=dict(type='data',array=train_std,visible=is_std), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Validation", y=validation_mae, x=x, error_y=dict(type='data',array=validation_std,visible=is_std), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Test", y=test_mae, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            
            fig.add_trace(go.Scatter(name="Training (Majority)", y=train_maj_mae, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Validation (Majority)", y=validation_maj_mae, x=x, error_y=dict(type='data',array=validation_maj_std,visible=is_std), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Test (Majority)", y=test_maj_mae, x=x, error_y=dict(type='data',array=test_maj_std,visible=is_std), mode='lines+markers', marker_size=10))
            
            fig.add_trace(go.Scatter(name="Training (Minority)", y=train_min_mae, x=x, error_y=dict(type='data',array=train_min_std,visible=is_std), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Validation (Minority)", y=validation_min_mae, x=x, error_y=dict(type='data',array=validation_min_std,visible=is_std), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Test (Minority)", y=test_min_mae, x=x, error_y=dict(type='data',array=test_min_std,visible=is_std), mode='lines+markers', marker_size=10))

            fig.update_xaxes(type="log") 
            fig.update_layout(title="The influence of hyperparameter C", template="simple_white",
                            paper_bgcolor="white", showlegend=True, xaxis_title="Hyperparameter C",
                            yaxis_title="MAE (eV)", titlefont=dict(size=24),
                            xaxis_title_font_size=24, yaxis_title_font_size=24, xaxis_linewidth=3, yaxis_linewidth=3,
                            xaxis_tickfont_size=20, yaxis_tickfont_size=20, width=1300, height=800)
            ...
            if is_show:
                fig.show()
            if is_std:
                fig.write_html(filename + "_mae.html")
            else:
                fig.write_html(filename + "_mae_nostd.html")
        ...
        case "rmse":
            ...
            fig.add_trace(go.Scatter(name="Training", y=train_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Validation", y=validation_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Test", y=test_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            
            fig.add_trace(go.Scatter(name="Training (Majority)", y=train_maj_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Validation (Majority)", y=validation_maj_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Test (Majority)", y=test_maj_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            
            fig.add_trace(go.Scatter(name="Training (Minority)", y=train_min_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Validation (Minority)", y=validation_min_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))
            fig.add_trace(go.Scatter(name="Test (Minority)", y=test_min_rmse, x=x, error_y=dict(type='data'), mode='lines+markers', marker_size=10))

            fig.update_xaxes(type="log") 
            fig.update_layout(title="The influence of hyperparameter C", template="simple_white",
                            paper_bgcolor="white", showlegend=True, xaxis_title="Hyperparameter C",
                            yaxis_title="RMSE (eV)", titlefont=dict(size=24),
                            xaxis_title_font_size=24, yaxis_title_font_size=24, xaxis_linewidth=3, yaxis_linewidth=3,
                            xaxis_tickfont_size=20, yaxis_tickfont_size=20, width=1300, height=800)
            ...
            fig.write_html(filename + "_rmse.html")